...
namespace ContraForce.Samples.HaloInbound.ContraForce;
...
public sealed class ContraForceClient
{
    ...
    )
    {
        ...
        var body = new UpdateIncidentStatusRequest(
            ...
            // Sentinel incidents — tweak if your Halo workflow drives different
            // classifications. "Undetermined" / "InaccurateData" are the safest
            // neutral defaults for a Halo-driven close.
